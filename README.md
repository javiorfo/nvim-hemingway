...
- The main strings used for comments are the ones taken from [this file](https://github.com/whiskoder/nvim-hemingway/blob/master/lua/hemingway.lua). If there is no value for the file you are using, you can set it in your personal Neovim init.lua:
```lua
...
<img src="https://github.com/whiskoder/img/blob/master/nvim-hemingway/hemingway.gif?raw=true" alt="lua comments" style="width:800px;"/>

**NOTE:** The colorscheme **malt** from [nvim-whisky](https://github.com/whiskoder/nvim-whisky) is used in these images.
